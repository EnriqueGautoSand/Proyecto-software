        ...
        try:
            ...
            for key in diccionario:
                try:
                    ...
                    print(e)
            cambios = ""
            if operation.name == "UPDATE" and len(self.modificado)>0:
            ...
            auditlog = Auditoria(message=strings, anterior=cambios,username=g.user.username, operation=operation, target=self.__class__.datamodel.model_name)
            try:
